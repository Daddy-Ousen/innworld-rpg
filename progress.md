...
- [ ] M9 — Book 3 (Flowers of Esthelm). Plan approved 2026-09-26 (ADR 0016, ROADMAP M9). 4 batches:
  - [x] M9.1 3.00 E – 3.05 L + 1.00 D / 1.01 D — built on branch `data/book3-3.00-3.05`, [PR #36](https://github.com/Daddy-Ousen/innworld-rpg/pull/36) open. 39 events, Persua guild fight (stage) + Lyonette reopening (scene), both with hooks. GUT 602/602 (65 scripts), validator 0 errors, Python 51/51.
  - [ ] M9.2 3.06 L – 3.14
...
- Canon: Book 1 (1.00–1.63, days 1–41) and Book 2 (Interlude – The Call to 2.48, days 41–71) are complete event data. Book 3: 3.00E–3.05L + 1.00D/1.01D (days 71–76, M9.1).
...
- Tests: 65 GUT scripts, 602 tests, all pass, headless exit 0. Python tool tests: 51 pass (`python -m unittest discover -s tools/tests`).
