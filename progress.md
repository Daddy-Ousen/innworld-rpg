...
- [ ] M8 — Book 2 (Fae and Fare) + Celum (plan approved 2026-09-25; 8 sub-modules, see ROADMAP and ADR 0014)
  ...
  - [ ] M8.3–M8.4 canon, M8.5 Celum map + start, M8.6 economy + travel, M8.7 canon
...
- Tests: 60 GUT scripts, 533 tests, all pass, headless exit 0. Python tool tests: 51 pass (`python -m unittest discover -s tools/tests`).
