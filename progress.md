...
- [ ] M6 — Vertical slice (plan approved 2026-09-23; 5 sub-modules, see ROADMAP and ADR 0011). All 5 parts done; M6 is done when PR for M6.5 is merged (tags `m6.5-done`, `m6-done`).
...
- Tests: 46 GUT scripts, 440 tests, all pass, headless exit 0. Python tool tests: 36 pass (`python -m unittest discover -s tools/tests`).
