...
- [ ] M6 — Vertical slice (plan approved 2026-09-23; 5 sub-modules, see ROADMAP and ADR 0011)
  ...
  - [x] M6.2 Canon 1.15–1.20R (branch `data/book1-1.15-1.20`): 11 events, 7 new NPCs, 4 new locations, reviewed by user 2026-09-24 (my picks: Goblin meal day 12, Ryoka window 13–16, Ryoka rumor kept, Persua/Queen/Izril later). Validator 0 errors. `sim_canon_book1` LAST_DAY 13, drift 0; new test: kill Klbkch → another guard saves Erin. GUT 383/383. PR #14 open (waiting on the user).
