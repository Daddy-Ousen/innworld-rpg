...
- [ ] M7.4 Canon 1.55R–1.63 (days 38–41): Ryoka breaks the geas at the Bloodfields; the expedition and Skinner; the dead attack Liscor and the inn; the Workers name themselves; Klbkch is reborn (new `revive` effect); Rags kills Skinner; Magnolia and Ryoka come to Liscor. Two canon stages on the night of day 39 (the east gate, the inn hill), each with a `change` hook — in review
