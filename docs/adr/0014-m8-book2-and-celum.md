...
**Flagged, not linked.** Selys "Shivertail" vs Zel Shivertail; the Goblin Lord's eyes vs Az'kerash; Mihaela vs Valceif Godfrey; Lyonette's [Princess] reveal vs Book 1's `princess_thief`; "Terrandria" spelling in 2.42. Perril Chandler = Az'kerash is stated in 2.48. 2.35 (M8.4) sets `ryoka.gained_first_class`, but the text has a faerie cancel the level-ups and 2.39 has Ryoka with no levels - left as it is, to put to the user. The Book 2 epub has web-serial author's notes (the Mating Rituals interlude, 2.48); they are ignored.
